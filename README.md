...
This was initially created for [Hartford Sub-Aqua Club (HSAC)](http://hartfordscuba.co.uk), and reflects
the way the club organises and manages it's resources - training kit, compressor, and oxygen bank.
...
The app is designed to be run in a web browser. It supports a number of services:
